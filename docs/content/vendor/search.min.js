! function () {
  ...
  function t(e) {
    localStorage.setItem("docsify.search.expires", Date.now() + e), localStorage.setItem("docsify.search.index", JSON.stringify(g))
  }

  function o(e, n, t, o) {
    void 0 === n && (n = "");
    var i, r = window.marked.lexer(n),
      a = window.Docsify.slugify,
      s = {};
    return r.forEach(function (n) {
      if ("heading" === n.type && n.depth <= o) i = t.toURL(e, {
        id: a(n.text)
      }), s[i] = {
        slug: i,
        title: n.text,
  ...
  function i(n) {
    ...
    Object.keys(g).forEach(function (e) {
      o = o.concat(Object.keys(g[e]).map(function (n) {
        return g[e][n]
      }))
    }), n = [].concat(n, n.trim().split(/[\s\-\ï¼Œ\\\/]+/));
    for (var i = 0; i < o.length; i++) ! function (i) {
      var r = o[i],
        ...
        f = r.slug || "";
      if (c && l && (n.forEach(function (n, t) {
          var o = new RegExp(n, "gi"),
            i = -1,
            r = -1;
          if (i = c && c.search(o), r = l && l.search(o), i < 0 && r < 0) a = !1;
          else {
            a = !0, r < 0 && (r = 0);
            var f = 0,
              d = 0;
  ...
  function r(e, i) {
    ...
    if (g = JSON.parse(localStorage.getItem("docsify.search.index")), a) g = {};
    else if (!r) return;
  ...
  function s(e, n) {
    void 0 === n && (n = "");
    var t = '<input type="search" value="' + n + '" /><div class="results-panel"></div></div>',
  ...
  function c(e) {
    ...
    }), t.classList.add("show"), t.innerHTML = r || '<p class="empty">' + y + "</p>"
  }
  ...
  function p(e, n) {
    ...
    a(), s(e, t), l(), t && setTimeout(function (e) {
      return c(t)
    }, 500)
  }
  ...
  var h, g = {},
    ...
    v = function (e, n) {
      var t = Docsify.util,
        o = n.config.search || m;
      Array.isArray(o) ? m.paths = o : "object" == typeof o && (m.paths = Array.isArray(o.paths) ? o.paths : "auto", m.maxAge = t.isPrimitive(o.maxAge) ? o.maxAge : m.maxAge, m.placeholder = o.placeholder || m.placeholder, m.noData = o.noData || m.noData, m.depth = o.depth || m.depth);
      var i = "auto" === m.paths;
